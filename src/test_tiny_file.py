...
# select the origin site options randomly(origin_domain)
...
domainname_value = "ds.eywedu.com"
domainname.send_keys(domainname_value)
time.sleep(1)

# select the origin host randomly(use the accelerate domian name)
resource_host = browser.find_elements_by_xpath("//span[@class='caret']")[2]
resource_host.click()
huiyuan_host = browser.find_element_by_css_selector(
    "li[data-value='useAccName']")
huiyuan_host.click()
...
remark_content = "all-kinds-of-novels"
remark_area.clear()
time.sleep(1)
...
time.sleep(1)
domainname = browser.find_element_by_name('domainName')
domainname_value = "ds.eywedu.com.cn"
domainname.clear()
time.sleep(1)
domainname.send_keys(domainname_value)
time.sleep(1)
...
remark_content = "rank-first-in-china"
remark_s_area.clear()
time.sleep(1)
remark_s_area.send_keys(remark_content)
time.sleep(1)
domainname_value = "read.eywedu.com.cn"
