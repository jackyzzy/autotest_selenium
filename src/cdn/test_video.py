...
domainname_value = "sports.sina.com.cn"
domainname.send_keys(domainname_value)
time.sleep(1)

# select the origin host randomly(wu)
resource_host = browser.find_elements_by_xpath("//span[@class='caret']")[2]
resource_host.click()
huiyuan_host = browser.find_element_by_css_selector("li[data-value='blank']")
huiyuan_host.click()
...
remark_content = "popular sports video"
remark_area.clear()
time.sleep(1)
...
time.sleep(1)
domainname = browser.find_element_by_name('domainName')
domainname_value = "nba.sports.sina.com"
domainname.clear()
time.sleep(1)
domainname.send_keys(domainname_value)
time.sleep(1)
...
remark_content = "sports fans' favorite"
remark_s_area.clear()
time.sleep(1)
remark_s_area.send_keys(remark_content)
time.sleep(1)
domainname_value = "uefa.sports.sina.com"
